# API Contracts: Game Start — First Round Drawer & Secret Word
...
```json
{
  ...
  "room": { /* RoomSnapshot, includes new participant; drawerId and currentWord are null in lobby */ }
}
```
